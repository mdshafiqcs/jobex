...
export default function SearchJob() {
  ...
  return (
      <>
        <div className='my-5 flex min-w-[400px] md:w-[70%] xl:w-[60%] h-[50px] shadow-lg border border-slate-200 pl-3 rounded-full items-center gap-4 mx-auto overflow-hidden'>
          <input 
          type="text" 
